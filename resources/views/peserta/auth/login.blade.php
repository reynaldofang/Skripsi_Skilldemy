...
@section('content')
        ...
        <main id="main" class="main-background">
            ...
            <form action="{{ route('peserta.login.post') }}" method="POST" class="main-account needs-validation">
                @csrf
                ...
                <div class="form-group">
                    <p>Don't have an account? <a href="{{ route('peserta.register') }}">Register Here</a></p>
                </div>
            </form>
        </main>
